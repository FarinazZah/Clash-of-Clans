/**
 * Concrete class extending Troop, used for autograding purposes only.
...
public class TroopConcrete extends Troop {
    /**
     * Constructs a TroopConcrete (which is, effectively, a Troop) with
     * the given name, experienceLevel, and health.
     *
    ...
    /**
     * The troop with train with another.
     * In this class, its sole purpose is to allow trainWith to be a concrete method, so
