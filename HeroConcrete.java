...
public class HeroConcrete extends Hero {
    ...
    /**
     * Constructs a HeroConcrete (which is, effectively, a Hero) with the given name, health, and damage.
     *
     * @param name of the hero
     * @param health of the hero
     * @param damage the hero deals
     */
    ...
    /**
     * Constructs a HeroConcrete (which is, effectively, a Hero) with the given name and health.
     *
     * @param name of the hero
     * @param health of the hero
     */
     ...
     * In this class, its sole purpose is to allow train to be a concrete method, so the implementaton is empty.
     *
     ...
     * In this class, its sole purpose is to allow hasArmor to be a concrete method, so the implementaton is empty.
     *
